...
const RequestNewCard: React.FC = () => {
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Your request for a new card has been sent to the administrators. 
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <h3 className="text-xl font-semibold mb-6">Request New Card</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            Why do you want to add this card? *
          </label>
          <textarea
            value={requestMessage}
            onChange={(e) => setRequestMessage(e.target.value)}
            placeholder="Please explain why you want to add this card and how it will benefit users..."
            rows={4}
            required
        ...
        >
          {isLoading ? 'Submitting Request...' : 'Submit Card Request'}
        </button>
      </form>
    </div>
  );
